import CBButton from '../4 Components/Basic/CBButton/CBButton'
import { Meta, Preview, Story } from '@storybook/addon-docs/blocks';


<Meta title="6 - Content Guidelines/Naming" component={CBButton}/>
...
<Preview>
  <Story name="btn1"> 
    {{ 
      components: { CBButton },                     
      template: '<CBButton type="primary">Save</CBButton>'
    }}    
    </Story>
     <Story name="btn2"> 
    {{ 
      components: { CBButton },                     
      template: '<CBButton type="primary">Unassign</CBButton>'
    }}    
    </Story>
     <Story name="btn2"> 
    {{ 
      components: { CBButton },                     
      template: '<CBButton type="primary">Assign Service</CBButton>'
    }}    
    </Story>
</Preview>

<img src="./images/content-guidelines/naming/submit-button.png" width="400"/>
