<<<<<<< HEAD
import Button from '../4 Components/Basic/Button/Button'
import { Meta, Preview, Story } from '@storybook/addon-docs/blocks';


<Meta title="6 - Content Guidelines/Naming" component={Button}/>
=======
import { Meta, Preview, Story, Canvas } from '@storybook/addon-docs/blocks';

<Meta title="6 - Content Guidelines/Naming"/>
>>>>>>> baza
...
- Also follow [Capitalization](/?path=/docs/6-content-guidelines-capitalization--page) guidelines.
...
<<<<<<< HEAD
  <Story name="button"> 
    {{ 
      components: { Button },                     
      template: '<Button type="primary">Save</Button>'
    }}   
    </Story>
    <Story name="button1">     
    {{ 
      components: { Button },                     
      template: '<Button type="primary">Unassign</Button>'
    }}   
    </Story>
    <Story name="button2">     
    {{ 
      components: { Button },                     
      template: '<Button type="primary">Assign Service</Button>'
    }}   
    </Story>
</Preview>
...
=======
  <Story name="btn1"> 
    {{ 
      template: '<el-button type="primary">Save</el-button>'
    }}    
    </Story>
     <Story name="btn2"> 
    {{ 
      template: '<el-button type="primary">Unassign</el-button>'
    }}    
    </Story>
     <Story name="btn3">    
    {{ 
      template: '<el-button type="primary">Assign Service</el-button>'
    }}    
    </Story>
</Preview>
...
## Object Names
By default a summary screen of any object should be called just as **NAME**. But sometime a screen title can also include an object class name. In this case an object name should be in double quotation marks.

<img src="./images/content-guidelines/naming/object-names.png" width="889"/>
